        ...
        <View style={styles.modulesContainer}>
          ...
          >
            ...
            >
              ...
              <Text style={styles.moduleTitle}>💬 V-Cirkel Coach</Text>
              <Text style={styles.moduleDescription}>
                24/7 AI-coach voor vragen over types, drijfveren en omgaan met anderen.
              </Text>
              <View style={styles.featureList}>
                <Text style={styles.feature}>✓ Stel elke vraag</Text>
                <Text style={styles.feature}>✓ Type-specifiek advies</Text>
                <Text style={styles.feature}>✓ Relatie-inzichten</Text>
              </View>
          ...
          <TouchableOpacity
            style={[styles.moduleCard, styles.comingSoon]}
            activeOpacity={0.6}
          >
            <LinearGradient
